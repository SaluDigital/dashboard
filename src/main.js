...
function checkFormValidity() {
  ...
  const rules = {
    ...
    possuiDominio: !!data.possuiDominio,
    desejaBlog: !!data.desejaBlog,
    orientadoSetup: !!data.orientadoSetup,
    procedimentosFoco: !!data.procedimentosFoco?.trim(),
    temRedesSociais: !!data.temRedesSociais,
    possuiGoogleNegocio: !!data.possuiGoogleNegocio,
    metaCliente: !!data.metaCliente?.trim(),
